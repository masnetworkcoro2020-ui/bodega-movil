...
# 1. Configuración con tu nombre real
st.set_page_config(page_title="Inversiones Lyan ERP", layout="centered")
supabase = conectar()
...
st.title("🔄 Inversiones Lyan - Sistema 360")
st.sidebar.metric("Tasa de Cambio", f"{tasa} Bs/$")
st.sidebar.success("Selecciona un módulo en el menú de arriba ☝️")

# --- 1. ESCÁNER ---
st.subheader("📸 Escáner de Producto")
...
if cod_actual:
    ...
    # LÓGICA MATEMÁTICA 360 ORIGINAL
    m = margen / 100
    ...
    if st.button("💾 GUARDAR CAMBIOS"):
        ...
        st.success("✅ ¡Guardado en Inversiones Lyan!")
        st.session_state.codigo_escaneado = ""
