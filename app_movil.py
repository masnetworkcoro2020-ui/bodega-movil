...
with tab2:
    ...
    # 2. BUSCADOR (Para jalar datos existentes)
    ...
    seleccion = st.selectbox("🔍 Buscar para editar:", opciones)
    ...
    # --- LÓGICA 360 CIRCULAR (EL MOTOR DE TU PC) ---
    ...
    # 5. LISTA DE INVENTARIO (LO QUE ME PEDISTE RECARGAR)
    st.divider()
...
with tab3:
    ...
    for u in res_u.data:
        ...
        if st.button(f"Borrar {u['usuario']}", key=f"btn_{u['usuario']}"):
