...
# 1. CONEXIÓN (Mantenemos tus 157 líneas de lógica base)
URL = "https://aznkqqrakzhvbtlnjaxz.supabase.co"
KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImF6bmtxcXJha3podmJ0bG5qYXh6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3Njk5NjY4NTAsImV4cCI6MjA4NTU0Mjg1MH0.4LRC-DsHidHkYyS4CiLUy51r-_lEgGPMvKL7_DnJWFI"
supabase = create_client(URL, KEY)

# 2. CONFIGURACIÓN Y ESTILOS (Formato teléfono sin perder colores)
...
# --- PESTAÑA INVENTARIO (LÓGICA REFORZADA) ---
with tab2:
    ...
    # --- MOTOR 360° COMPLETO (SIN RECORTES) ---
    factor = (1 + (in_mar / 100))

    # 1. CAMBIO EN COSTO BS (Adelante)
    ...
    # 3. CAMBIO EN MARGEN (Empuja ventas)
    ...
    # TABLA DE INVENTARIO (Tu lista completa)
    st.divider()
